...
class AchievementsControllerTest < ActionController::TestCase
  ...
  test "should create achievement" do
    assert_difference('Achievement.count') do
      post :create, achievement: { amount: @achievement.amount, name: @achievement.name, student_id: @achievement.student_id }
    end
  ...
  test "should update achievement" do
    patch :update, id: @achievement, achievement: { amount: @achievement.amount, name: @achievement.name, student_id: @achievement.student_id }
    assert_redirected_to achievement_path(assigns(:achievement))
  end
